...
export const WhatsAppIcon = () => (
  <svg {...base}>
    <path d="M20.5 11.8A8.5 8.5 0 0 1 7.2 19l-3.2.9.9-3.1A8.5 8.5 0 1 1 20.5 11.8Z" />
    <path d="M9.2 8.8c.2-.4.5-.4.7-.4h.6c.2 0 .4.1.5.4l.7 1.7c.1.3 0 .5-.2.7l-.5.5c.5 1 1.3 1.8 2.3 2.3l.5-.5c.2-.2.5-.3.7-.2l1.7.7c.3.1.4.3.4.5v.6c0 .2 0 .5-.4.7-.5.2-1 .3-1.5.3-3.5 0-6.3-2.8-6.3-6.3 0-.5.1-1 .3-1.5Z" />
  </svg>
);